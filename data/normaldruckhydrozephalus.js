...
export const NPH_LESSON = {
  ...
  mrt: {
    ...
    rows: [
      [L('Aquädukt-Flow-void', 'Aqueductal flow void', 'فقدان سیگنال جریان (flow void) آکوئداکت'), L('Prominentes Strömungssignal in sagittaler T2/CISS', 'Prominent flow void on sagittal T2/CISS', 'سیگنال جریان برجسته در T2/CISS ساژیتال'), L('Unterstützend, aber nicht ausreichend spezifisch und nicht allein prognostisch', 'Supportive but insufficiently specific and not a stand-alone prognostic marker', 'حمایتی است اما اختصاصی یا پیش‌آگهی‌دهنده مستقل نیست')],
    ...
    key: L('Ein kräftiger Aquädukt-Flow-void ist ein Puzzleteil – kein alleiniger Shunt-Prädiktor.', 'A strong aqueductal flow void is one piece of the puzzle, not a stand-alone shunt predictor.', 'فقدان سیگنال جریان (flow void) قوی آکوئداکت تنها بخشی از پازل است و پیش‌بینی‌کننده مستقل شانت نیست.'),
  },
  differenzial: {
  ...
  fall: {
    ...
    frameLabels: [
      ...
      L('Sagittale CISS/T2: Aquädukt-Flow-void', 'Sagittal CISS/T2: aqueductal flow void', 'CISS/T2 ساژیتال: فقدان سیگنال جریان (flow void) آکوئداکت'),
...
const NF = [
  ...
  F('flowvoid', L('MRT', 'MRI', 'MRI'), L('Aquädukt-Flow-void?', 'Aqueductal flow void?', 'فقدان سیگنال جریان (flow void) آکوئداکت؟'), L('Unterstützendes Zeichen erhöhten pulsierenden Liquorflusses.', 'A supportive sign of increased pulsatile CSF flow.', 'علامت حمایتی جریان ضربانی بیشتر CSF.'), L('Weder spezifisch noch sicherer Shunt-Prädiktor.', 'Neither specific nor a reliable shunt predictor.', 'نه اختصاصی و نه پیش‌بینی‌کننده قطعی شانت.')),
