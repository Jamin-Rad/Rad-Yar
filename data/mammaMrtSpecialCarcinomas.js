...
const QUESTIONS = [
  {
    ...
    options: [
      ...
      L('Alle Zusatzareale entsprechen wahrscheinlich Background Parenchymal Enhancement, da ILC nur als Mass wächst.', 'All additional areas probably represent background parenchymal enhancement because ILC grows only as a mass.', 'همه نواحی اضافی احتمالاً BPE هستند، زیرا ILC فقط به‌شکل توده رشد می‌کند.'),
    ],
    correct: 'A',
  ...
  },
  {
    ...
    question: L(
      ...
      "یک توده بیضی با حاشیه نسبتاً واضح، در T2 بسیار پرسیگنال است و تقویت پس از تزریق تدریجی و پایدار دارد. کدام عبارت دقیق‌تر است؟"
    ),
    options: [
      ...
      L('Persistentes Enhancement schließt Malignität sicher aus.', 'Persistent enhancement safely excludes malignancy.', "تقویت پایدار پس از تزریق بدخیمی را با اطمینان رد می‌کند."),
  ...
  },
  {
    ...
    options: [
      ...
      L('Nur lineares NME ohne Mass oder Nekrose', 'Linear NME only, without a mass or necrosis', 'فقط NME خطی بدون توده یا نکروز'),
      L('Runde oder ovale Mass mit Thick Rim Enhancement, zentraler Nekrose und peritumoralem Ödem', 'A round or oval mass with thick rim enhancement, central necrosis and peritumoral oedema', "توده گرد یا بیضی با تقویت حلقوی ضخیم، نکروز مرکزی و ادم پری‌تومورال"),
      L('Nicht anreichernde fetthaltige Mass mit kompletter Fettsuppression', 'A non-enhancing fat-containing mass with complete fat suppression', 'توده چربی‌دار بدون تقویت پس از تزریق با سرکوب کامل چربی'),
    ],
    correct: 'C',
    explanation: L('TNBC manifestiert sich häufig als Mass mit runder/ovaler Form, teils relativ scharfem Rand, Thick Rim Enhancement, Nekrose, T2-Hyperintensität und peritumoralem Ödem. Gerade der scheinbar benigne Rand ist ein Fallstrick.', 'TNBC often presents as a round or oval mass, sometimes with a relatively circumscribed margin, thick rim enhancement, necrosis, T2 hyperintensity and peritumoral oedema. The apparently benign margin is a key pitfall.', "TNBC اغلب به‌شکل توده گرد یا بیضی، گاهی با حاشیه نسبتاً واضح، تقویت حلقوی ضخیم، نکروز، پرسیگنالی T2 و ادم پری‌تومورال ظاهر می‌شود؛ حاشیه ظاهراً خوش‌خیم یک دام مهم است."),
    wrongExplanations: {
      A: L('Symmetrische BPE ist normales hormonabhängiges Parenchym-Enhancement und kein typisches fokales TNBC-Muster.', 'Symmetric BPE is normal hormonally influenced parenchymal enhancement and is not a typical focal TNBC pattern.', 'BPE قرینه تقویت پس از تزریق طبیعی و وابسته به هورمون پارانشیم است و الگوی کانونی تیپیک TNBC محسوب نمی‌شود.'),
      B: L('TNBC erscheint häufiger als anreichernde Mass als ausschließlich als lineares NME. Das charakteristische Zusammenspiel aus Mass, Rim Enhancement und Nekrose fehlt hier.', 'TNBC more often appears as an enhancing mass than isolated linear NME. The characteristic combination of mass, rim enhancement and necrosis is absent.', 'TNBC بیشتر به‌شکل توده دارای تقویت پس از تزریق دیده می‌شود تا NME خطی منفرد؛ ترکیب مشخص توده، Rim تقویت پس از تزریق و نکروز در این گزینه وجود ندارد.'),
      D: L('Eine nicht anreichernde fetthaltige Läsion spricht eher für einen benignen fetthaltigen Befund. Sie erklärt weder den typischen TNBC-Phänotyp noch dessen Nekrose und peripheres Enhancement.', 'A non-enhancing fat-containing lesion favours a benign fat-containing finding and does not match the typical TNBC phenotype with necrosis and peripheral enhancement.', 'ضایعه چربی‌دار بدون تقویت پس از تزریق بیشتر به نفع یافته خوش‌خیم است و با فنوتیپ تیپیک TNBC شامل نکروز و تقویت پس از تزریق محیطی تطابق ندارد.'),
    },
  },
  {
    id: 'ibc-clinical',
    question: L(
      ...
      'بیماری طی چند هفته دچار اریتم، پوست پرتقالی و تورم یک پستان شده است. MRI ضخیم‌شدگی منتشر پوست، ادم و NME ناهمگن را بدون توده غالب نشان می‌دهد. کدام عبارت درست است؟'
    ),
    options: [
      L('Ohne dominante Mass ist ein inflammatorisches Mammakarzinom ausgeschlossen.', 'Without a dominant mass, inflammatory breast cancer is excluded.', 'بدون توده غالب، سرطان التهابی پستان رد می‌شود.'),
  ...
  },
  {
    ...
    question: L(
      ...
      "یک توده هفت سانتی‌متری با رشد سریع، سیگنال ناهمگن و بالا در T2، تقویت حلقوی ضخیم و نواحی وسیع نکروز دارد. بیوپسی سوزنی فقط «نکروز و التهاب» گزارش می‌کند. اقدام مناسب چیست؟"
    ),
    options: [
      L('Der Befund ist radiologisch-pathologisch diskordant; aus dem vital anreichernden Anteil muss erneut gezielt Gewebe gewonnen werden.', 'The result is radiologic–pathologic discordant; repeat targeted sampling of the viable enhancing component is required.', 'یافته رادیولوژی و پاتولوژی ناسازگار است؛ باید از بخش زنده و دارای تقویت پس از تزریق نمونه‌برداری هدفمند مجدد انجام شود.'),
    ...
    correct: 'A',
    explanation: L('Metaplastische Karzinome können stark heterogen und nekrotisch sein. Eine Biopsie aus dem Zentrum kann nur Nekrose erfassen; bei Diskordanz ist eine erneute, auf vitales anreicherndes Gewebe gerichtete Probengewinnung erforderlich.', 'Metaplastic carcinomas may be markedly heterogeneous and necrotic. Central sampling may retrieve only necrosis; discordance requires repeat sampling directed at viable enhancing tissue.', 'کارسینوم متاپلاستیک می‌تواند بسیار ناهمگن و نکروتیک باشد. نمونه‌برداری مرکزی ممکن است فقط نکروز را نشان دهد؛ در صورت عدم تطابق باید از بافت زنده دارای تقویت پس از تزریق دوباره نمونه‌برداری شود.'),
    wrongExplanations: {
  ...
  },
  {
    ...
    options: [
      L('Thick Rim Enhancement beweist einen triple-negativen Rezeptorstatus.', 'Thick rim enhancement proves triple-negative receptor status.', "تقویت حلقوی ضخیم وضعیت گیرنده سه‌گانه منفی را اثبات می‌کند."),
...
const CARDS = [
  ...
  ['ILC', 'Schließt eine nur geringe Kontrastmittelaufnahme ein invasiv-lobuläres Karzinom aus?', 'Nein. ILC kann diskret oder verzögert anreichern und als NME oder Architekturstörung imponieren.', 'Bei bekannter lobulärer Histologie ist die Suche nach subtiler Ausdehnung wichtiger als die stärkste Kurve.', 'ILC', 'Does weak enhancement exclude invasive lobular carcinoma?', 'No. ILC may enhance subtly or late and may present as NME or architectural distortion.', 'With known lobular histology, searching for subtle extent is more important than finding the strongest curve.', 'ILC', 'آیا تقویت پس از تزریق خفیف کارسینوم لوبولار مهاجم را رد می‌کند؟', 'خیر. ILC ممکن است تقویت پس از تزریق خفیف یا تأخیری داشته و به‌شکل NME یا دیستورشن معماری ظاهر شود.', 'در بافت‌شناسی لوبولار شناخته‌شده، جست‌وجوی وسعت ظریف از یافتن شدیدترین منحنی مهم‌تر است.'],
