...
export const MOYAMOYA_LESSON = {
  ...
  definition: L(
    'Seltene, progressive Erkrankung mit ein- oder beidseitiger Stenose bzw. Okklusion am terminalen intrakraniellen ICA-Abschnitt und charakteristischer Kollateralgefäßbildung („Puff of Smoke“).',
    'Rare progressive disease with unilateral or bilateral stenosis or occlusion at the terminal intracranial ICA and characteristic collateral formation producing the "puff of smoke" appearance.',
    'بیماری پیشرونده نادر با تنگی یا انسداد یک‌طرفه یا دوطرفه در بخش انتهایی ICA داخل جمجمه‌ای و تشکیل عروق کولاترال با نمای «پف دود».',
  ),
    ...
    items: [
      {
        ...
        text:  L(
          'Moya-Moya-Krankheit wird diagnostiziert, wenn die Gefäßkriterien erfüllt und assoziierte Ursachen ausgeschlossen sind; sie kann ein- oder beidseitig sein. Bei einer bekannten Grunderkrankung (z. B. Down-Syndrom, NF1) spricht man von Moya-Moya-Syndrom.',
          'Moyamoya disease is diagnosed when vascular criteria are met and associated causes are excluded; it may be unilateral or bilateral. Similar vasculopathy with a known underlying condition (e.g. Down syndrome or NF1) is termed moyamoya syndrome.',
          'بیماری مویامویا زمانی تشخیص داده می‌شود که معیارهای عروقی وجود داشته و علل همراه رد شده باشند؛ درگیری می‌تواند یک‌طرفه یا دوطرفه باشد. واسکولوپاتی مشابه همراه با بیماری زمینه‌ای شناخته‌شده، مانند سندرم داون یا NF1، «سندرم مویامویا» نام دارد.',
        ),
      },
      {
        icon: '🌏',
  ...
  bildgebung: {
    ...
    mriRows: [
      [L('T2 / FLAIR (nativ)', 'T2 / FLAIR (non-enhanced)', 'T2 / FLAIR (بدون کنتراست)'), L('Flow Voids in Basalganglien, Thalami und interner Kapsel', 'Flow voids in basal ganglia, thalami and internal capsule', 'فقدان سیگنال جریان (flow void) در بازال گانگلیا، تالاموس و کپسول داخلی'), L('Direkte Darstellung der Moya-Moya-Kollateralgefäße', 'Direct depiction of Moya-Moya collateral vessels', 'نمایش مستقیم عروق کولاترال Moya-Moya')],
      [L('FLAIR + Gadolinium → Ivy Sign', 'FLAIR + gadolinium → ivy sign', "FLAIR + گادولینیوم → علامت پیچک (Ivy sign)"), L('Lineare/gyriforme leptomeningeale KM-Aufnahme entlang der Sulci – wie Efeu am Hirn', 'Linear/gyriform leptomeningeal enhancement along sulci – like ivy on the brain', "تقویت لپتومننژیال خطی/ژیریفرم در امتداد شیارهای مغزی – مثل پیچک روی مغز"), L('Pathognomonisch für Moya-Moya; Zeichen aktiver langsamer leptomeningealer Kollateralversorgung', 'Pathognomonic for moyamoya; sign of active slow leptomeningeal collateral supply', 'پاتوگنومونیک Moya-Moya؛ نشانه کولاترال لپتومننژیال فعال با جریان کند')],
    ...
    ivyKey: L(
      ...
      "علامت پیچک (Ivy sign) در Gd-FLAIR حساس‌ترین و اختصاصی‌ترین علامت MRI در Moya-Moya فعال است. نام آن از الگوی شبیه پیچک کولاترال‌های لپتومننژیال روی سطح مغز گرفته شده است.",
    ),
  },
    ...
    items: [
      {
        ...
        text:  L(
          ...
          'آناستوموز شریان تمپورال سطحی (STA) با شاخه‌ای از MCA. بهبود فوری پرفیوژن. استاندارد طلایی در بزرگسالان.',
        ),
      },
      {
        icon: '🌱',
        ...
        text:  L(
          ...
          "EDAS (انسفالودوروآرتریوسینانژیوز (EDAS)): STA روی سطح مغز دوخته می‌شود و طی چند هفته نئوواسکولاریزاسیون ایجاد می‌کند. روش انتخابی در کودکان.",
        ),
      },
      {
        icon: '🔄',
  ...
  takehome: {
    ...
    items: [
      { title: L('Flow Voids + Ivy Sign', 'Flow voids + ivy sign', 'فقدان سیگنال جریان + علامت پیچک'), text: L('T2 Flow Voids in Basalganglien + Ivy Sign auf Gd-FLAIR = klassisches MRT-Bild von Moya-Moya. Beide Zeichen aktiv suchen.', 'T2 flow voids in basal ganglia + ivy sign on Gd-FLAIR = classic MRI picture of moyamoya. Actively search for both signs.', "فقدان سیگنال جریان (flow void) در T2 در بازال گانگلیا + علامت پیچک (Ivy sign) در Gd-FLAIR = تصویر کلاسیک MRI در Moya-Moya. هر دو علامت را فعالانه جستجو کنید.") },
...
export const MOYAMOYA_QUESTION_SEEDS = [
  ...
  Q('ivysign',
    L('Welches MRT-Zeichen ist für Moya-Moya charakteristisch und spiegelt langsamen leptomeningealen Kollateralfluss wider?', 'Which MRI sign is characteristic of moyamoya and reflects slow leptomeningeal collateral flow?', 'کدام علامت MRI برای مویامویا مشخصه است و جریان آهسته کولاترال‌های لپتومننژیال را نشان می‌دهد؟'),
    [L('Ivy Sign – lineares bzw. giriformes leptomeningeales Signal auf FLAIR', 'Ivy sign – linear or gyriform leptomeningeal signal on FLAIR', 'علامت پیچک: سیگنال خطی یا ژیریفرم لپتومننژیال در FLAIR'), L('Empty-delta-Zeichen eines Sinusverschlusses', 'Empty delta sign of dural sinus thrombosis', 'علامت دلتای خالی در ترومبوز سینوس دورال'), L('Blooming eines Kavernoms in SWI', 'Blooming of a cavernoma on SWI', 'آرتیفکت blooming کاورنوم در SWI'), L('Hyperintense Arterie bei akutem thromboembolischem Verschluss', 'Hyperintense artery in acute thromboembolic occlusion', 'شریان هایپراینتنس در انسداد حاد ترومبوآمبولیک')],
    0,
    L('Das Ivy Sign beschreibt ein lineares oder giriformes FLAIR-Signal entlang der Sulci bei langsamem leptomeningealem Kollateralfluss. Es ist ein charakteristischer, unterstützender Befund und kein alleiniger Diagnosenachweis.', 'The ivy sign is linear or gyriform FLAIR signal along the sulci associated with slow leptomeningeal collateral flow. It is a characteristic supportive finding, not diagnostic by itself.', 'علامت پیچک به سیگنال خطی یا ژیریفرم FLAIR در امتداد شیارها در اثر جریان آهسته کولاترال‌های لپتومننژیال گفته می‌شود. این یافته مشخصه و حمایتی است، اما به‌تنهایی تشخیص را قطعی نمی‌کند.'),
  ),
  Q('goldstandard',
  ...
  Q('flowvoids',
    L('Was repräsentieren die Flow Voids in den Basalganglien im T2-MRT?', 'What do T2 MRI flow voids in the basal ganglia represent?', 'فقدان سیگنال جریان (flow void) در بازال گانگلیا در T2 MRI نشان‌دهنده چه هستند؟'),
  ...
  Q('sequence',
    L('Welche MRT-Sequenz zeigt das Ivy Sign am besten?', 'Which MRI sequence best demonstrates the ivy sign?', "کدام سکوانس MRI علامت پیچک (Ivy sign) را بهترین نشان می‌دهد؟"),
  ...
  Q('association',
    ...
    [L('Diabetes mellitus Typ 2', 'Type 2 diabetes mellitus', 'دیابت ملیتوس نوع ۲'), L('Down-Syndrom (Trisomie 21)', 'Down syndrome (trisomy 21)', 'سندرم داون (تریزومی ۲۱)'), L('Sichelzellanämie', 'Sickle cell disease', 'آنمی سلول داسی'), L('Hirnbestrahlung in der Kindheit', 'Cranial irradiation in childhood', 'پرتودرمانی مغز در دوران کودکی')],
    0,
    L('Klassische Assoziationen sind Down-Syndrom, NF1, Sichelzellanämie, Hirnbestrahlung, Turner-Syndrom und Marfan-Syndrom. Diabetes Typ 2 gehört nicht dazu.', 'Classic associations include Down syndrome, NF1, sickle cell disease, cranial irradiation, Turner syndrome and Marfan syndrome. Type 2 diabetes is not among them.', 'اسوسیاسیون‌های کلاسیک شامل سندرم داون، NF1، آنمی سلول داسی، پرتودرمانی مغز، سندرم ترنر و سندرم مارفان است. دیابت نوع ۲ در این لیست نیست.'),
  ),
  Q('perfusion',
  ...
  Q('bilateral',
    ...
    [L('Bei ähnlicher Vasculopathie und bekannter assoziierter Grunderkrankung, z. B. Down-Syndrom, NF1 oder Sichelzellkrankheit', 'With similar vasculopathy and a known associated condition such as Down syndrome, NF1 or sickle cell disease', 'در واسکولوپاتی مشابه همراه با بیماری زمینه‌ای شناخته‌شده مانند سندرم داون، NF1 یا بیماری سلول داسی'), L('Bei jedem einseitigen Befall unabhängig von der Ursache', 'With any unilateral involvement regardless of cause', 'در هر درگیری یک‌طرفه، صرف‌نظر از علت'), L('Nur bei Suzuki-Grad VI', 'Only at Suzuki grade VI', 'فقط در درجه VI سوزوکی'), L('Ausschließlich bei Kindern unter 5 Jahren', 'Exclusively in children under 5 years', 'فقط در کودکان زیر ۵ سال')],
    0,
    L('Nach den revidierten Kriterien von 2021 kann eine Moya-Moya-Krankheit ein- oder beidseitig sein. Der Begriff Moya-Moya-Syndrom bezeichnet die gleiche Gefäßkonstellation im Zusammenhang mit einer bekannten Grunderkrankung.', 'Under the revised 2021 criteria, moyamoya disease may be unilateral or bilateral. Moyamoya syndrome describes the same vascular pattern in association with a known underlying disorder.', 'طبق معیارهای بازنگری‌شده ۲۰۲۱، بیماری مویامویا می‌تواند یک‌طرفه یا دوطرفه باشد. اصطلاح سندرم مویامویا برای همین الگوی عروقی در همراهی با یک بیماری زمینه‌ای شناخته‌شده به کار می‌رود.'),
  ),
]
...
export const MOYAMOYA_FLASHCARD_TOPIC = {
  ...
  title:    L('Moya-Moya', 'Moyamoya Disease', 'بیماری Moya-Moya'),
  subtitle: L('Pathophysiologie · Bildgebung · Ivy Sign · Suzuki · Therapie', 'Pathophysiology · Imaging · Ivy sign · Suzuki · Treatment', "پاتوفیزیولوژی · تصویربرداری · علامت پیچک (Ivy sign) · سوزوکی · درمان"),
}
...
const FLASH_SEEDS = [
  ...
  F('flowvoids',
    L('MRT', 'MRI', 'MRI'),
    L('Was repräsentieren T2 Flow Voids in den Basalganglien bei Moya-Moya?', 'What do T2 flow voids in the basal ganglia represent in moyamoya?', 'فقدان سیگنال جریان (flow void) در T2 در بازال گانگلیا در Moya-Moya چه چیزی را نشان می‌دهند؟'),
  ...
  F('ivysign',
    L('MRT', 'MRI', 'MRI'),
    L('Was ist das Ivy Sign auf Gd-FLAIR?', 'What is the ivy sign on Gd-FLAIR?', "علامت پیچک (Ivy sign) در Gd-FLAIR چیست؟"),
    L('Lineare/gyriforme leptomeningeale KM-Aufnahme entlang der Sulci durch langsam fließende Kollateralen – wie Efeu am Hirn.', 'Linear/gyriform leptomeningeal enhancement along sulci from slowly flowing collaterals – like ivy on the brain.', "تقویت لپتومننژیال خطی/ژیریفرم در امتداد شیارهای مغزی ناشی از کولاترال‌های با جریان کند – مثل پیچک روی مغز."),
    L('Das Ivy Sign ist das sensibelste und spezifischste MRT-Zeichen für Moya-Moya. Auch auf nativem FLAIR manchmal schwach sichtbar. Auf nativem T1 nicht sichtbar.', 'The ivy sign is the most sensitive and specific MRI sign for moyamoya. Sometimes faintly visible on non-enhanced FLAIR. Not visible on non-enhanced T1.', "علامت پیچک (Ivy sign) حساس‌ترین و اختصاصی‌ترین علامت MRI برای Moya-Moya است. گاهی در FLAIR بدون کنتراست ضعیف قابل مشاهده است. در T1 بدون کنتراست قابل مشاهده نیست."),
    L('Gd-FLAIR → Ivy Sign ✓ (sensitiv + spezifisch)\nT1 nativ → kein Ivy Sign\nFLAIR nativ → manchmal schwach', 'Gd-FLAIR → ivy sign ✓ (sensitive + specific)\nNon-enhanced T1 → no ivy sign\nNon-enhanced FLAIR → sometimes faint', "Gd-FLAIR → علامت پیچک (Ivy sign) ✓ (حساس + اختصاصی)\nT1 بدون کنتراست → بدون علامت پیچک (Ivy sign)\nFLAIR بدون کنتراست → گاهی ضعیف"),
  ),
  F('goldstandard',
  ...
  F('bypass-direct',
    ...
    L('STA-MCA-Bypass: Anastomose der A. temporalis superficialis mit einem kortikalen MCA-Ast.', 'STA-MCA bypass: anastomosis of superficial temporal artery with a cortical MCA branch.', 'بای‌پس STA-MCA: آناستوموز شریان تمپورال سطحی با شاخه‌ای از MCA.'),
  ...
  F('edas',
    ...
    L('Enzephaloduroarteriosynangiose: STA auf Hirnoberfläche vernäht → induziert Neovaskularisation über Wochen. Bevorzugt bei Kindern.', 'Encephalo-duro-arterio-synangiosis: STA sutured onto brain surface → induces neovascularisation over weeks. Preferred in children.', "انسفالودوروآرتریوسینانژیوز (EDAS): STA روی سطح مغز دوخته می‌شود → نئوواسکولاریزاسیون طی چند هفته. ترجیح در کودکان."),
  ...
  F('associations',
    ...
    L('Down-Syndrom, NF1, Sichelzellanämie, Hirnbestrahlung, Turner-Syndrom, Marfan-Syndrom.', 'Down syndrome, NF1, sickle cell disease, cranial irradiation, Turner syndrome, Marfan syndrome.', 'سندرم داون، NF1، آنمی سلول داسی، پرتودرمانی مغز، سندرم ترنر، سندرم مارفان.'),
    L('Moya-Moya-Krankheit kann ein- oder beidseitig sein, sofern assoziierte Ursachen ausgeschlossen sind. Bei bekannter Grunderkrankung spricht man von Moya-Moya-Syndrom.', 'Moyamoya disease may be unilateral or bilateral when associated causes are excluded. With a known underlying condition, the term moyamoya syndrome is used.', 'بیماری مویامویا در صورت رد علل همراه می‌تواند یک‌طرفه یا دوطرفه باشد. در حضور بیماری زمینه‌ای شناخته‌شده، اصطلاح سندرم مویامویا به کار می‌رود.'),
  ),
  F('perfusion',
    ...
    L('Acetazolamide (Diamox) Challenge: Reduktion der CVR unter Belastung beweist hämodynamisch relevante Stenose.', 'Acetazolamide (Diamox) challenge: reduction in CVR under stress proves haemodynamically significant stenosis.', 'آزمون چالشی استازولامید (Diamox): کاهش CVR تحت استرس، تنگی با اهمیت همودینامیک را ثابت می‌کند.'),
  ),
  F('cave',
