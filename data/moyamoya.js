...
export const MOYAMOYA_QUESTION_SEEDS = [
  ...
  Q('ivysign',
    ...
    [L('Ivy Sign – lineare leptomeningeale Aufnahme auf Gd-FLAIR', 'Ivy sign – linear leptomeningeal enhancement on Gd-FLAIR', 'علامت پیچک (Ivy sign): تقویت لپتومننژیال خطی در Gd-FLAIR'), L('Empty delta sign', 'Empty delta sign', 'علامت دلتای خالی'), L('Blooming artifact in SWI', 'Blooming artefact on SWI', 'آرتیفکت شکوفه‌ای در SWI'), L('Bright artery sign in DWI', 'Bright artery sign on DWI', 'علامت شریان روشن در DWI')],
    0,
    L('Das Ivy Sign beschreibt die gyriforme Enhancement-Aufnahme entlang der Sulci durch langsam fließende leptomeningeale Kollateralen auf Gd-FLAIR – wie Efeu auf der Hirnoberfläche.', 'The ivy sign describes gyriform enhancement along sulci from slow-flowing leptomeningeal collaterals on Gd-FLAIR – like ivy on the brain surface.', 'علامت پیچک (Ivy sign) تقویت ژیریفرم در امتداد شیارهای مغزی ناشی از کولاترال‌های لپتومننژیال کم‌جریان در Gd-FLAIR را توصیف می‌کند؛ نمایی شبیه پیچک روی سطح مغز.'),
  ),
  Q('goldstandard',
