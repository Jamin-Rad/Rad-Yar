  ...
  "de": [
    {
      ...
      "options": [
        {
          "id": "A",
          "text": "Höhere Osmolarität als ionische KM"
        },
        {
          "id": "B",
          "text": "Nur enteral zugelassen"
        },
        {
          "id": "C",
          "text": "Niedrigere Osmolarität und besser verträglich"
        },
        {
          "id": "D",
          "text": "Tragen eine negative Ladung"
        }
      ],
      "correct": "C",
    ...
    },
    {
      ...
      "options": [
        {
          "id": "A",
          "text": "Reine portalvenöse Abdomen-Phase"
        },
        {
          "id": "B",
          "text": "Ausschluss einer Lungenarterienembolie (LAE-CT)"
        },
        {
          "id": "C",
          "text": "Native Schädel-CT ohne KM"
        },
        {
          "id": "D",
          "text": "KM-Gabe über einen Zentralvenenkatheter (ZVK)"
        }
      ],
      "correct": "B",
    ...
    },
    {
      ...
      "options": [
        {
          "id": "A",
          "text": "Kreatininanstieg ≥ 0,3 mg/dl oder ≥ 1,5-fach innerhalb 48–72 h nach KM-Gabe"
        },
        {
          "id": "B",
          "text": "GFR-Abfall um 10 % nach 7 Tagen"
        },
        {
          "id": "C",
          "text": "Anurie innerhalb von 6 h nach KM-Gabe"
        },
        {
          "id": "D",
          "text": "Harnstoffanstieg um das 2-fache nach 24 h"
        }
      ],
      "correct": "A",
    ...
    },
    {
      ...
      "options": [
        {
          "id": "A",
          "text": "Sie ist IgE-vermittelt gegen elementares Jod"
        },
        {
          "id": "B",
          "text": "Sie existiert nicht – Jod als kleines Molekül ist nicht allergen"
        },
        {
          "id": "C",
          "text": "Sie erfordert immer eine Adrenalin-Prophylaxe vor jeder KM-Gabe"
        },
        {
          "id": "D",
          "text": "Sie tritt nur bei makrozyklischen Gadolinium-KM auf"
        }
      ],
      "correct": "B",
    ...
    },
    {
      ...
      "options": [
        {
          "id": "A",
          "text": "Gadovist® (Gadobutrol)"
        },
        {
          "id": "B",
          "text": "Dotarem® (Gadoterat)"
        },
        {
          "id": "C",
          "text": "Primovist® (Gadoxetsäure)"
        },
        {
          "id": "D",
          "text": "Gastrografin® (Diatrizoat)"
        }
      ],
      "correct": "C",
    ...
    },
    {
      ...
      "options": [
        {
          "id": "A",
          "text": "Kontrolle des TSH-Wertes beim Neugeborenen"
        },
        {
          "id": "B",
          "text": "Generelles Stillverbot für mindestens 2 Wochen"
        },
        {
          "id": "C",
          "text": "Ganzkörper-MRT des Neugeborenen zur Verteilungskontrolle"
        },
        {
          "id": "D",
          "text": "Sofortige prophylaktische Gabe von L-Thyroxin beim Säugling"
        }
      ],
      "correct": "A",
    ...
    },
    {
      ...
      "options": [
        {
          "id": "A",
          "text": "Stillen erst nach Gabe von Aktivkohle beim Kind erlaubt"
        },
        {
          "id": "B",
          "text": "Eine Stillpause ist medizinisch nicht notwendig"
        },
        {
          "id": "C",
          "text": "Abpumpen und Verwerfen der ersten Mahlzeit nach 12 Stunden"
        },
        {
          "id": "D",
          "text": "Zwingende Stillpause für 48 Stunden zur Sicherheit"
        }
      ],
      "correct": "B",
    ...
    },
    {
      ...
      "options": [
        {
          "id": "A",
          "text": "Strenge Indikationsstellung und Fehlen gleichwertiger KM-freier Alternativen"
        },
        {
          "id": "B",
          "text": "Durchführung der Untersuchung ausschließlich unter Vollnarkose"
        },
        {
          "id": "C",
          "text": "Vorliegender negativer Hauttest der Mutter auf KM-Bestandteile"
        },
        {
          "id": "D",
          "text": "Schriftliche Zustimmung des betreuenden Gynäkologen"
        }
      ],
      "correct": "A",
    ...
    },
    {
      ...
      "options": [
        {
          "id": "A",
          "text": "Metformin muss bei allen Patienten 48 h vor der Untersuchung abgesetzt werden"
        },
        {
          "id": "B",
          "text": "Bei eGFR > 30 ml/min/1,73 m² kann Metformin normal weitergeführt werden"
        },
        {
          "id": "C",
          "text": "Metformin erhöht direkt die Nephrotoxizität des Kontrastmittels"
        },
        {
          "id": "D",
          "text": "Bei Dialysepatienten ist Metformin unbedenklich weiterzuführen"
        }
      ],
      "correct": "B",
    ...
    },
    {
      ...
      "options": [
        {
          "id": "A",
          "text": "Schwere Niereninsuffizienz (GFR < 30) und Gabe linearer Gadolinium-KM"
        },
        {
          "id": "B",
          "text": "Normale Nierenfunktion und einmalige Gabe makrozyklischer Gadolinium-KM"
        },
        {
          "id": "C",
          "text": "Jodhaltiges CT-Kontrastmittel bei normaler Schilddrüsenfunktion"
        },
        {
          "id": "D",
          "text": "Buscopan®-Gabe vor einer MRT-Untersuchung"
        }
      ],
      "correct": "A",
  ...
  "en": [
    {
      ...
      "options": [
        {
          "id": "A",
          "text": "Higher osmolality than ionic contrast media"
        },
        {
          "id": "B",
          "text": "Approved only for enteral use"
        },
        {
          "id": "C",
          "text": "Lower osmolality and better tolerated"
        },
        {
          "id": "D",
          "text": "Carry a negative charge"
        }
      ],
      "correct": "C",
    ...
    },
    {
      ...
      "options": [
        {
          "id": "A",
          "text": "Pure portal venous abdominal phase"
        },
        {
          "id": "B",
          "text": "Exclusion of pulmonary embolism (CTPA)"
        },
        {
          "id": "C",
        ...
        {
          "id": "D",
          "text": "Contrast injection via a central venous catheter"
        }
      ],
      "correct": "B",
    ...
    },
    {
      ...
      "options": [
        {
          "id": "A",
          "text": "Creatinine rise ≥ 0.3 mg/dl or ≥ 1.5-fold within 48–72 h after contrast"
        },
        {
          "id": "B",
          "text": "10% GFR drop after 7 days"
        },
        {
          "id": "C",
          "text": "Anuria within 6 h after contrast injection"
        },
        {
          "id": "D",
          "text": "Doubling of urea within 24 h"
        }
      ],
      "correct": "A",
    ...
    },
    {
      ...
      "options": [
        {
          "id": "A",
          "text": "It is IgE-mediated against elemental iodine"
        },
        {
          "id": "B",
          "text": "It does not exist — iodine is not allergenic as a small molecule"
        },
        {
          "id": "C",
          "text": "It always requires epinephrine prophylaxis before contrast"
        },
        {
          "id": "D",
          "text": "It only occurs with macrocyclic gadolinium agents"
        }
      ],
      "correct": "B",
    ...
    },
    {
      ...
      "options": [
        ...
        {
          "id": "B",
          "text": "Dotarem® (gadoterate)"
        },
        {
          "id": "C",
          "text": "Primovist® (gadoxetate)"
        },
        {
          "id": "D",
          "text": "Gastrografin® (diatrizoate)"
        }
      ],
      "correct": "C",
    ...
    },
    {
      ...
      "options": [
        {
          "id": "A",
          "text": "Check the newborn's TSH level"
        },
        {
          "id": "B",
          "text": "Breastfeeding ban for at least 2 weeks"
        },
        {
          "id": "C",
          "text": "Whole-body MRI of the newborn"
        },
        {
          "id": "D",
          "text": "Immediate prophylactic L-thyroxine to the infant"
        }
      ],
      "correct": "A",
    ...
    },
    {
      ...
      "options": [
        {
          "id": "A",
          "text": "Only permitted after activated charcoal for the infant"
        },
        {
          "id": "B",
          "text": "A breastfeeding pause is medically not necessary"
        },
        {
          "id": "C",
          "text": "Pump and discard the first feed after 12 hours"
        },
        {
          "id": "D",
          "text": "Mandatory 48-hour breastfeeding pause"
        }
      ],
      "correct": "B",
    ...
    },
    {
      ...
      "options": [
        {
          "id": "A",
          "text": "Strict indication AND no equivalent contrast-free alternative"
        },
        {
          "id": "B",
          "text": "Examination must be performed under general anesthesia only"
        },
        {
          "id": "C",
          "text": "Negative skin test to contrast components"
        },
        {
          "id": "D",
          "text": "Written consent of the obstetrician"
        }
      ],
      "correct": "A",
    ...
    },
    {
      ...
      "options": [
        {
          "id": "A",
          "text": "Metformin must be stopped 48 h before in all patients"
        },
        {
          "id": "B",
          "text": "With eGFR > 30 ml/min/1.73 m², metformin can be continued"
        },
        {
          "id": "C",
          "text": "Metformin directly increases contrast nephrotoxicity"
        },
        {
          "id": "D",
          "text": "In dialysis patients, metformin can be continued safely"
        }
      ],
      "correct": "B",
    ...
    },
    {
      ...
      "options": [
        {
          "id": "A",
          "text": "Severe renal impairment (GFR < 30) and administration of linear gadolinium agents"
        },
        {
          "id": "B",
          "text": "Normal renal function and a single macrocyclic gadolinium injection"
        },
        {
          "id": "C",
          "text": "Iodinated CT contrast in normal thyroid function"
        },
        {
          "id": "D",
          "text": "Buscopan® before MRI"
        }
      ],
      "correct": "A",
  ...
  "fa": [
    {
      ...
      "options": [
        {
          "id": "A",
          "text": "اسمولاریته بالاتر نسبت به ماده حاجب یونی"
        },
        {
          "id": "B",
          "text": "فقط برای مصرف روده‌ای مجاز است"
        },
        {
          "id": "C",
          "text": "اسمولاریته پایین‌تر و تحمل‌پذیری بهتر"
        },
        {
          "id": "D",
          "text": "دارای بار منفی است"
        }
      ],
      "correct": "C",
    ...
    },
    {
      ...
      "options": [
        {
          "id": "A",
          "text": "فاز وریدی پورتال شکم"
        },
        {
          "id": "B",
          "text": "رد آمبولی ریوی (CTPA)"
        },
        {
          "id": "C",
          "text": "سی‌تی اسکن سر بدون ماده حاجب"
        },
        {
          "id": "D",
          "text": "تزریق از طریق کاتتر وریدی مرکزی"
        }
      ],
      "correct": "B",
    ...
    },
    {
      ...
      "options": [
        {
          "id": "A",
          "text": "افزایش کراتینین ≥۰.۳ میلی‌گرم/دسی‌لیتر یا ≥۱.۵ برابر در طی ۴۸–۷۲ ساعت"
        },
        {
          "id": "B",
          "text": "کاهش ۱۰٪ GFR بعد از ۷ روز"
        },
        {
          "id": "C",
          "text": "آنوری در طی ۶ ساعت پس از تزریق"
        },
        {
          "id": "D",
          "text": "دو برابر شدن اوره خون در ۲۴ ساعت"
        }
      ],
      "correct": "A",
    ...
    },
    {
      ...
      "options": [
        {
          "id": "A",
          "text": "واکنش IgE-واسطه در برابر ید عنصری است"
        },
        {
          "id": "B",
          "text": "وجود ندارد – ید به عنوان مولکول کوچک آلرژن نیست"
        },
        {
          "id": "C",
          "text": "همیشه نیاز به پروفیلاکسی با آدرنالین دارد"
        },
        {
          "id": "D",
          "text": "فقط با مواد حاجب گادولینیوم ماکروسیکلیک رخ می‌دهد"
        }
      ],
      "correct": "B",
    ...
    },
    {
      ...
      "options": [
        {
          "id": "A",
          "text": "Gadovist® (گادوبوترول)"
        },
        {
          "id": "B",
          "text": "Dotarem® (گادوتِرات)"
        },
        {
          "id": "C",
          "text": "Primovist® (گادوکستات)"
        },
        {
          "id": "D",
          "text": "Gastrografin® (دیاتریزوات)"
        }
      ],
      "correct": "C",
    ...
    },
    {
      ...
      "options": [
        {
          "id": "A",
          "text": "بررسی سطح TSH نوزاد"
        },
        {
          "id": "B",
          "text": "ممنوعیت کلی شیردهی حداقل ۲ هفته"
        },
        {
          "id": "C",
          "text": "MRI کل بدن نوزاد"
        },
        {
          "id": "D",
          "text": "تجویز فوری L-تیروکسین پروفیلاکتیک"
        }
      ],
      "correct": "A",
    ...
    },
    {
      ...
      "options": [
        {
          "id": "A",
          "text": "فقط پس از دادن زغال فعال به نوزاد مجاز است"
        },
        {
          "id": "B",
          "text": "از نظر پزشکی نیازی به قطع شیردهی نیست"
        },
        {
          "id": "C",
          "text": "پمپ کردن و دور ریختن اولین شیردهی بعد از ۱۲ ساعت"
        },
        {
          "id": "D",
          "text": "توقف اجباری شیردهی به مدت ۴۸ ساعت"
        }
      ],
      "correct": "B",
    ...
    },
    {
      ...
      "options": [
        {
          "id": "A",
          "text": "اندیکاسیون قوی و نبود روش‌های تشخیصی معادل بدون ماده حاجب"
        },
        {
          "id": "B",
          "text": "انجام بررسی فقط تحت بیهوشی عمومی"
        },
        {
          "id": "C",
          "text": "تست پوستی منفی مادر"
        },
        {
          "id": "D",
          "text": "رضایت کتبی متخصص زنان"
        }
      ],
      "correct": "A",
    ...
    },
    {
      ...
      "options": [
        {
          "id": "A",
          "text": "متفورمین در همه بیماران ۴۸ ساعت قبل باید قطع شود"
        },
        {
          "id": "B",
          "text": "با eGFR > ۳۰ میلی‌لیتر/دقیقه/۱.۷۳ مترمربع متفورمین ادامه می‌یابد"
        },
        {
          "id": "C",
          "text": "متفورمین مستقیماً سمیت کلیوی ماده حاجب را افزایش می‌دهد"
        },
        {
          "id": "D",
          "text": "در بیماران دیالیزی متفورمین بدون خطر ادامه می‌یابد"
        }
      ],
      "correct": "B",
    ...
    },
    {
      ...
      "options": [
        {
          "id": "A",
          "text": "نارسایی شدید کلیه (GFR < 30) همراه با تزریق گادولینیوم خطی"
        },
        {
          "id": "B",
          "text": "عملکرد طبیعی کلیه و یک بار تزریق گادولینیوم ماکروسیکلیک"
        },
        {
          "id": "C",
          "text": "ماده حاجب یددار CT در عملکرد طبیعی تیروئید"
        },
        {
          "id": "D",
          "text": "تزریق Buscopan® پیش از MRI"
        }
      ],
      "correct": "A",
