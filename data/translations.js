export const translations = {
  ...
  de: {
    ...
    heroDesc: 'Strukturiertes Wissen, interaktive Fälle und gezielte Prüfungsvorbereitung für Radiologinnen und Radiologen in Weiterbildung – kostenlos und ohne Registrierung.',
    cta: 'Jetzt entdecken',
  ...
  en: {
    ...
    tagline: 'Your Guide in Radiology Education',
    heroSub: 'Radiology Education',
    heroDesc: 'Structured knowledge, interactive cases and targeted exam prep for radiology residents – completely free, no registration required.',
    cta: 'Start Learning',
  ...
  fa: {
    ...
    heroDesc: 'دانش ساختارمند، موارد بالینی تعاملی و آمادگی هدفمند برای رزیدنت‌های رادیولوژی – کاملاً رایگان، بدون نیاز به ثبت‌نام.',
    cta: 'شروع آموزش',
