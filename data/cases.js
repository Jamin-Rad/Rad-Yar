export const CASE_BANK = {
  de: [
    ...
    },
    {
      ...
      title: 'Progressive Auffüllung zweier Leberläsionen',
      vignette: '60-jährige Patientin mit Zufallsbefund in der Lebersonografie. In der Mehrphasen-CT zeigen sich zwei hypodense Leberläsionen: eine kleine runde Läsion in Segment VIII und eine größere lobulierte Läsion in Segment V/VI.',
      question: 'Welche Diagnose passt am besten zum dargestellten dynamischen Kontrastmittelverhalten?',
      options: [
        { id: 'A', text: 'Hepatische Hämangiome mit peripher-globulärer Anreicherung und zentripetalem Fill-in' },
      ...
      correct: 'A',
      explanation: 'Beide Läsionen zeigen eine progressive, peripher-globuläre Kontrastmittelaufnahme mit zentripetaler Auffüllung und vollständiger Homogenisierung in der Spätphase. Dieses Blutpool-Verhalten ist klassisch für hepatische Hämangiome und darf nicht mit einem malignen Ringenhancement verwechselt werden.',
  ...
  en: [
    ...
    },
    {
      ...
      title: 'Progressive fill-in of two liver lesions',
      vignette: '60-year-old woman with an incidental finding on liver ultrasound. Multiphasic CT demonstrates two hypoattenuating liver lesions: a small round lesion in segment VIII and a larger lobulated lesion in segments V/VI.',
      question: 'Which diagnosis best fits the dynamic enhancement pattern?',
      options: [
        { id: 'A', text: 'Hepatic haemangiomas with peripheral globular enhancement and centripetal fill-in' },
      ...
      correct: 'A',
      explanation: 'Both lesions show progressive peripheral globular enhancement, centripetal fill-in and complete homogenisation on the delayed phase. This blood-pool pattern is classic for hepatic haemangiomas and should not be mistaken for malignant rim enhancement.',
      source: 'https://radiopaedia.org/cases/20956',
  ...
  fa: [
    ...
    },
    {
      ...
      title: 'پرشدگی پیشرونده دو ضایعه کبدی',
      vignette: 'خانم ۶۰ ساله با یافته اتفاقی در سونوگرافی کبد. در CT چندفازی دو ضایعه هیپودنس کبدی دیده می‌شود: یک ضایعه کوچک و گرد در سگمان VIII و یک ضایعه بزرگ‌تر و لوبوله در سگمان‌های V و VI.',
      question: 'کدام تشخیص با الگوی دینامیک جذب ماده حاجب بیشترین تطابق را دارد؟',
      options: [
        { id: 'A', text: 'همانژیوم‌های کبدی با enhancement گلوبولار محیطی و پرشدگی مرکزگرا' },
      ...
      correct: 'A',
      explanation: 'هر دو ضایعه enhancement گلوبولار محیطی پیشرونده، پرشدگی مرکزگرا و همگن‌شدن کامل در فاز تأخیری دارند. این الگوی blood-pool برای همانژیوم کبدی تیپیک است و نباید با rim enhancement بدخیم اشتباه شود.',
      source: 'https://radiopaedia.org/cases/20956',
