...
export const KLASSIFIKATIONEN = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: 'cdd-einfach',
        name: { de: 'CDD (Einfach)', en: 'CDD (Simple)', fa: 'CDD (ساده)' },
        kompakt: {
          de: 'Klassifikation der Divertikelkrankheit (DGAV/DGVS): Typ 0–4 für die CT-Befundung – von asymptomatischer Divertikulose über akute und chronische Entzündung bis zur Divertikelblutung.',
          en: 'Classification of Diverticular Disease (DGAV/DGVS): type 0–4 for CT reporting – from asymptomatic diverticulosis through acute and chronic inflammation to diverticular bleeding.',
          fa: 'طبقه‌بندی بیماری دیورتیکولی (DGAV/DGVS): نوع ۰–۴ – از دیورتیکولوز بدون علامت تا التهاب حاد، مزمن و خونریزی.',
        },
        ref: 'Leifeld et al., Z Gastroenterol 2014 · DGAV/DGVS-Leitlinie',
        cols: [{ de: 'Typ', en: 'Type', fa: 'نوع' }, { de: 'Befund', en: 'Finding', fa: 'یافته' }],
        rows: [
      ...
      {
        id: 'cdd',
        name: { de: 'CDD (Vollständig)', en: 'CDD (Full)', fa: 'CDD (کامل)' },
        kompakt: {
          de: 'Vollständige Klassifikation der Divertikelkrankheit (DGAV/DGVS) mit allen Subtypen: 1a/1b (unkompliziert), 2a/2b/2c (kompliziert: Mikro-/Makroabszess/freie Perforation) und 3a/3b/3c (chronisch-rezidivierend, SUDD). Jeder Subtyp hat direkte CT-Kriterien.',
          en: 'Full Classification of Diverticular Disease (DGAV/DGVS) with all subtypes: 1a/1b (uncomplicated), 2a/2b/2c (complicated: micro-/macroabscess/free perforation) and 3a/3b/3c (chronic recurrent, SUDD). Each subtype has direct CT criteria.',
          fa: 'طبقه‌بندی کامل بیماری دیورتیکولی با همه زیرگروه‌ها: ۱a/1b (بدون عارضه)، ۲a/2b/2c (پیچیده: میکروآبسه/ماکروآبسه/پرفوراسیون) و ۳a/3b/3c (مزمن-عودکننده، SUDD). هر زیرگروه معیار CT مستقیم دارد.',
        },
        ref: 'Leifeld et al., Z Gastroenterol 2014 · DGAV/DGVS-Leitlinie',
