...
export const KLASSIFIKATIONEN = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        kompakt: {
          de: 'Klassifiziert Menge und Verteilung subarachnoidalen Bluts im CT (Grad 1–4) als Prädiktor für das Vasospasmusrisiko nach SAB.',
          en: 'Classifies blood volume and distribution on CT in SAH (grade 1–4) as a predictor of vasospasm risk.',
          fa: 'حجم و توزیع خون زیرعنکبوتیه را در CT (درجه ۱–۴) به‌عنوان پیش‌بینی‌کننده خطر وازواسپاسم بعد از SAH طبقه‌بندی می‌کند.',
        },
