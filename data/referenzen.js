...
export const ANATOMIE = [
  ...
  },
  {
    ...
    cols: [{ de: 'Lappen', en: 'Lobe', fa: 'ناحیه' }, { de: 'Segmente', en: 'Segments', fa: 'سگمان‌های مهم' }],
    rows: [
      [{ de: 'Rechter Oberlappen', en: 'Right upper lobe', fa: 'لوب فوقانی راست' }, { de: 'S1 apikal\nS2 posterior\nS3 anterior', en: 'S1 apical\nS2 posterior\nS3 anterior', fa: 'S1 آپیکال، S2 خلفی، S3 قدامی.' }],
      [{ de: 'Mittellappen', en: 'Middle lobe', fa: 'لوب میانی' }, { de: 'S4 lateral\nS5 medial', en: 'S4 lateral\nS5 medial', fa: 'S4 لترال، S5 مدیال؛ محو شدن حاشیه راست قلب.' }],
      [{ de: 'Rechter Unterlappen', en: 'Right lower lobe', fa: 'لوب تحتانی راست' }, { de: 'S6 superior\nS7 medial-basal\nS8 anterior-basal\nS9 lateral-basal\nS10 posterior-basal', en: 'S6 superior\nS7 medial basal\nS8 anterior basal\nS9 lateral basal\nS10 posterior basal', fa: 'S6 فوقانی، S7 بازال مدیال، S8 بازال قدامی، S9 بازال لترال، S10 بازال خلفی.' }],
      [{ de: 'Linker Oberlappen / Lingula', en: 'Left upper lobe / lingula', fa: 'لوب فوقانی چپ / لینگولا' }, { de: 'S1+2 apikoposterior\nS3 anterior\nS4 superior-lingular\nS5 inferior-lingular', en: 'S1+2 apicoposterior\nS3 anterior\nS4 superior lingular\nS5 inferior lingular', fa: 'S1+2 آپیکوپوستریور، S3 قدامی، S4 لینگولار فوقانی، S5 لینگولار تحتانی.' }],
      [{ de: 'Linker Unterlappen', en: 'Left lower lobe', fa: 'لوب تحتانی چپ' }, { de: 'S6 superior\nS8 anteromedial-basal\nS9 lateral-basal\nS10 posterior-basal', en: 'S6 superior\nS8 anteromedial basal\nS9 lateral basal\nS10 posterior basal', fa: 'S6 فوقانی، S8 بازال قدامی‌مدیال، S9 بازال لترال، S10 بازال خلفی.' }],
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        rows: [
          ...
          ['2a', { de: 'Gedeckte Perforation: Mikroabszess / kleiner Abszess (≤ 3 cm)', en: 'Covered perforation: micro-abscess / small abscess (≤ 3 cm)', fa: 'پرفوراسیون پوشیده: میکروآبسه / آبسه کوچک' }, { de: 'Abszess ≤ 3 cm perikolisch; minimale parakolische Luft möglich', en: 'Abscess ≤ 3 cm pericolic; minimal paracolic air may be present', fa: 'آبسه ≤ ۳ سانتی‌متر پریکولیک؛ هوای پاراکولیک حداقل ممکن است دیده شود' }],
          ['2b', { de: 'Gedeckte Perforation: Makroabszess (> 3 cm)', en: 'Covered perforation: macro-abscess (> 3 cm)', fa: 'پرفوراسیون پوشیده: آبسه بزرگ' }, { de: 'Abszess > 3 cm, para- oder mesokolisch / pelvin', en: 'Abscess > 3 cm, para- or mesocolic / pelvic', fa: 'آبسه > ۳ سانتی‌متر، پاراکولیک یا مزوکولیک / لگنی' }],
      ...
      },
      {
        ...
        einfach: {
          ...
          rows: [
            ...
            [{ de: 'Typ B', en: 'Type B', fa: 'نوع B' }, { de: 'Fraktur im Bereich des Prothesenschafts\nUnterteilung nach Prothesenstabilität und Knochenqualität.', en: 'Fracture around the prosthetic stem\nSubdivided by implant stability and bone quality.', fa: 'شکستگی در ناحیه ساقه پروتز\nبر اساس پایداری پروتز و کیفیت استخوان تقسیم می‌شود.' }],
        ...
        cols: [
          { de: 'Typ', en: 'Type', fa: 'نوع' },
          { de: 'Unterteilung / Lokalisation', en: 'Subtype / location', fa: 'زیرگروه / محل' },
          { de: 'Therapieprinzip', en: 'Treatment principle', fa: 'اصل درمان' },
        ],
        rows: [
          [
            { de: 'Typ A', en: 'Type A', fa: 'نوع A' },
            { de: 'AG: Fraktur des Trochanter major\nAL: Fraktur des Trochanter minor', en: 'AG: greater trochanter fracture\nAL: lesser trochanter fracture', fa: 'AG: شکستگی تروکانتر بزرگ\nAL: شکستگی تروکانتر کوچک' },
            { de: 'Prothese stabil\noft konservative Therapie möglich', en: 'Stable implant\noften suitable for conservative treatment', fa: 'پروتز پایدار است\nاغلب درمان محافظه‌کارانه ممکن است' },
          ],
          [
            { de: 'Typ B', en: 'Type B', fa: 'نوع B' },
            { de: 'B1: Prothese stabil, Knochen gut\nB2: Prothese locker, Knochen gut\nB3: Prothese locker, Knochen schlecht mit Knochenverlust', en: 'B1: stable implant, good bone stock\nB2: loose implant, good bone stock\nB3: loose implant, poor bone stock with bone loss', fa: 'B1: پروتز پایدار، کیفیت استخوان خوب\nB2: پروتز لق، کیفیت استخوان خوب\nB3: پروتز لق، کیفیت استخوان نامناسب همراه با کاهش استخوان' },
            { de: 'B1: Osteosynthese möglich\nB2: Revisions-TEP erforderlich\nB3: Revisions-TEP plus alloplastischer Aufbau, z. B. Allograft oder langer Schaft', en: 'B1: osteosynthesis is possible\nB2: revision arthroplasty is required\nB3: revision arthroplasty plus reconstruction, e.g. allograft or long stem', fa: 'B1: استئوسنتز امکان‌پذیر است\nB2: تعویض/بازنگری پروتز لازم است\nB3: تعویض/بازنگری پروتز همراه با بازسازی، مانند آلوگرافت یا ساقه بلند' },
          ],
          [
            { de: 'Typ C', en: 'Type C', fa: 'نوع C' },
