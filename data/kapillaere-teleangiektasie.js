...
export const TELEANGIEKTASIE_LESSON = {
  ...
  bildgebung: {
    ...
    rows: [
      ...
      ['SWI/T2*', L('Korrespondierender hypointenser Fokus beziehungsweise Blooming', 'Corresponding hypointense focus or blooming', "کانون هیپواینتنس یا آرتیفکت شکوفه‌ای (blooming) متناظر"), L('Signalabfall beruht meist auf Deoxy-Hb im langsamen Fluss, nicht auf Blutung', 'Signal loss usually reflects deoxyhaemoglobin in slow flow, not haemorrhage', 'افت سیگنال معمولاً ناشی از دئوکسی‌هموگلوبین جریان آهسته است نه خونریزی')],
...
const TQ = [
  ...
  Q('08', L('Welche Läsion zeigt eher ein Caput-medusae-Muster?', 'Which lesion is more likely to show a caput-medusae pattern?', "کدام ضایعه بیشتر الگوی نمای سر مدوزا (Caput medusae) دارد؟"), ['DVA', L('Kapilläre Teleangiektasie', 'Capillary telangiectasia', 'تلانژکتازی مویرگی'), L('Kavernom', 'Cavernoma', 'کاورنوم'), L('Mikroblutung', 'Microbleed', 'میکروخونریزی')], 0, L('Konvergierende Medullarvenen und Sammelvene sind typisch für DVA.', 'Converging medullary veins and a collector are typical of DVA.', 'وریدهای مدولاری همگرا و ورید جمع‌کننده برای DVA تیپیک‌اند.')),
...
const TF = [
  ...
  F('dva', L('Differenzial', 'Differential', 'افتراقی'),
    ...
    L('Fleckige Anreicherung statt Caput-medusae-Venen.', 'Patchy enhancement rather than caput-medusae veins.', "افزایش لکه‌ای به‌جای وریدهای نمای سر مدوزا (Caput medusae)."),
