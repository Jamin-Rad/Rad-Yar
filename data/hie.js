...
export const HIE_LESSON = {
  ...
  mri: {
    ...
    rows: [
      ...
      ['T1 C+', L('subakut mögliches gyriformes kortikales Enhancement', 'possible subacute gyriform cortical enhancement', 'احتمال تقویت پس از تزریق ژیری‌فرم کورتکس در فاز زیرحاد'), L('Blut-Hirn-Schrankenstörung; kann Wochen persistieren', 'blood-brain barrier disruption; may persist for weeks', 'اختلال سد خونی-مغزی؛ ممکن است چند هفته باقی بماند')],
    ],
    key: L(
      ...
      "سیگنال بالای DWI بدون کاهش ADC محدودیت واقعی را ثابت نمی‌کند؛ اثر عبور سیگنال T2 (shine-through) و آرتیفکت باید رد شوند."
    ),
  },
  timeline: {
    ...
    items: [
      ...
      { title: L('Subakut: 1–3 Wochen', 'Subacute: 1–3 weeks', 'زیرحاد: ۱ تا ۳ هفته'), text: L('ADC pseudonormalisiert; laminäre kortikale Nekrose und gyriformes Enhancement können erscheinen.', 'ADC pseudonormalises; cortical laminar necrosis and gyriform enhancement may appear.', 'ADC ممکن است شبه‌طبیعی شود و نکروز لامینار کورتکس یا تقویت پس از تزریق ژیری‌فرم ظاهر شود.') },
  ...
  prognosis: {
    ...
    reportItems: [
      ...
      { title: L('3. Sequenzbefund', '3. Sequence findings', '۳. یافته سکانس‌ها'), text: L('DWI und ADC gemeinsam, zusätzlich FLAIR, SWI und gegebenenfalls Enhancement beurteilen.', 'Interpret DWI with ADC and assess FLAIR, SWI and enhancement when available.', 'DWI همراه ADC و نیز FLAIR، SWI و در صورت وجود تقویت پس از تزریق ارزیابی شوند.') },
...
const MCQ_SEEDS = [
  ...
  {
    id: 'white-cerebellum',
    question: L('Was beschreibt das White-cerebellum- beziehungsweise Reversal-Zeichen?', 'What does the white cerebellum or reversal sign describe?', 'علامت مخچه سفید (مخچه سفید (White cerebellum)) یا Reversal چه چیزی را توصیف می‌کند؟'),
    options: [
      ...
      L('Kontrastmittelanreicherung nach Angiografie', 'Contrast enhancement after angiography', 'تقویت پس از تزریق پس از آنژیوگرافی'),
    ],
    correct: 'A',
