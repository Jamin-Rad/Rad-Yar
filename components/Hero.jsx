...
const ZONES = [
  ...
  },
  {
    id: 'Hals',
    transform: 'translate(-5 0)',
    d: 'M384 207 C384 229 386 252 381 275 C384 291 391 306 401 316 C407 323 414 328 421 330 C433 328 443 323 453 316 C467 306 477 291 480 275 C475 252 477 229 477 207 C463 228 445 240 421 241 C407 240 395 228 384 207 Z',
  },
  {
    id: 'Technik',
