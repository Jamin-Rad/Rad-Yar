...
const ZONES = [
  ...
  },
  {
    id: 'Hals',
    transform: 'translate(-5 0)',
    d: 'M374 207 C374 229 376 252 371 275 C374 291 383 306 395 316 C403 323 412 328 421 330 C433 328 443 323 453 316 C467 306 477 291 480 275 C475 252 477 229 477 207 C463 228 445 240 421 241 C402 240 386 228 374 207 Z',
  },
  {
    id: 'Technik',
