...
const ZONES = [
  ...
  },
  {
    id: 'Hals',
    transform: 'translate(-5 0)',
    d: 'M365 207 C365 229 367 252 362 275 C365 291 375 306 389 316 C399 323 409 328 421 330 C433 328 443 323 453 316 C467 306 477 291 480 275 C475 252 477 229 477 207 C463 228 445 240 421 241 C397 240 379 228 365 207 Z',
  },
  {
    id: 'Technik',
