...
const ZONES = [
  ...
  },
  {
    id: 'Neuroradiologie',
    transform: 'translate(-5 0)',
    d: 'M421 36 C444 37 466 48 478 68 C486 82 488 101 486 121 C493 124 496 134 493 149 C490 164 483 176 475 181 C471 197 462 212 449 223 C440 231 431 236 421 238 C411 236 402 231 393 223 C377 212 365 197 359 181 C349 176 340 164 337 149 C334 134 338 123 346 119 C343 99 346 80 356 65 C370 46 396 37 421 36 Z',
  },
  {
    id: 'Brust',
