...
const ZONES = [
  ...
  },
  {
    id: 'Abdomen',
    transform: 'translate(-5 0)',
    // Curved superior border follows the diaphragmatic contour; the inferior
    // border stops at the pelvic brim so the abdomen remains selectable down
    // to the lower bowel without spilling over the pelvic organs.
    d: 'M302 548 C334 560 372 568 421 568 C470 568 508 560 540 548 C548 575 552 603 550 631 C548 662 540 690 540 718 C540 744 546 768 551 790 C520 806 476 815 421 815 C366 815 322 806 291 790 C296 768 302 744 302 718 C302 690 294 662 292 631 C290 603 294 575 302 548 Z',
  },
  {
    id: 'Becken',
    transform: 'translate(-5 0)',
    d: 'M291 790 C326 799 367 806 421 806 C475 806 516 799 551 790 C563 807 570 827 570 847 C568 874 553 899 529 920 C500 944 462 954 421 954 C380 954 342 944 313 920 C289 899 274 874 272 847 C272 827 279 807 291 790 Z',
  },
  {
    id: 'Neuroradiologie',
    transform: 'translate(-5 0)',
