...
const ZONES = [
  ...
  },
  {
    id: 'Hals',
    transform: 'translate(-5 0)',
    d: 'M373 207 C380 228 380 253 373 275 C365 295 354 307 336 316 C356 331 385 338 421 338 C461 338 491 331 497 316 C493 307 490 295 487 275 C477 253 476 228 486 207 C468 229 447 241 421 241 C402 241 387 229 373 207 Z',
  },
  {
    id: 'Neuroradiologie',
    transform: 'translate(-5 0)',
