...
const ZONES = [
  ...
  },
  {
    id: 'Hals',
    transform: 'translate(-5 0)',
    d: 'M365 207 C373 228 373 253 364 275 C355 295 342 307 321 316 C345 331 379 338 421 338 C471 338 510 331 537 316 C513 307 497 295 487 275 C477 253 476 228 486 207 C468 229 447 241 421 241 C398 241 381 229 365 207 Z',
  },
  {
    id: 'Neuroradiologie',
    transform: 'translate(-5 0)',
