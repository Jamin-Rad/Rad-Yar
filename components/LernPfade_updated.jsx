...
// MCQ topic selection links per pillar index
const MCQ_LINKS = {
  de: [null, '/mcq', null],
  en: [null, '/mcq', null],
  fa: [null, '/mcq', null],
...
export default function LernPfade() {
  ...
  const mcqCta = MCQ_CTA[lang] || MCQ_CTA.de
  const mcqLinks = MCQ_LINKS[lang] || MCQ_LINKS.de
        ...
        {texts.pillars.map((p, i) => {
          ...
          return (
            <div key={i} className={styles.card}
              ...
              {mcqHref && (
                <Link href={mcqHref} className={styles.mcqBtn} style={{ color: c.num, borderColor: c.border }}>
                  {mcqCta}
                </Link>
              )}
            </div>
