...
function RegionIcon({ id, size = 17 }) {
  ...
  const icons = {
    neuro: (
      <>
        <path {...s} d="M9 3C6.5 3 4.5 5 4.5 7.5C4.5 8.3 4.7 9 5.2 9.6C4.2 10.2 3.5 11.3 3.5 12.5C3.5 14.4 5.1 16 7 16H9v4h6v-4h2c1.9 0 3.5-1.6 3.5-3.5C20.5 11.3 19.8 10.2 18.8 9.6C19.3 9 19.5 8.3 19.5 7.5C19.5 5 17.5 3 15 3H9Z"/>
        <path {...s} d="M12 9v4M10 11h4"/>
      </>
    ),
    thorax: (
      <>
        <path {...s} d="M12 3v3.5M8.5 6.5C6.5 6.5 4.5 8.5 4.5 11v3.5c0 2 1.5 3.5 3.5 3.5H9c.8 0 1.5-.7 1.5-1.5V8c0-.8-.7-1.5-1.5-1.5Z"/>
        <path {...s} d="M15.5 6.5C17.5 6.5 19.5 8.5 19.5 11v3.5c0 2-1.5 3.5-3.5 3.5H15c-.8 0-1.5-.7-1.5-1.5V8c0-.8.7-1.5 1.5-1.5Z"/>
      </>
    ),
    herz: (
    ...
    abdomen: (
      <>
        ...
        <path {...s} d="M9 8.5c0 1.7.8 2.5 3 2.5s3-.8 3-2.5"/>
        <path {...s} d="M9 15.5c0-1.7.8-2.5 3-2.5s3 .8 3 2.5"/>
        <line {...s} x1="12" y1="11" x2="12" y2="13"/>
      </>
    ),
    urogenital: (
      <>
        <path {...s} d="M12 4C9 4 6.5 7.5 6.5 11.5C6.5 15.5 9 20 12 20C14.8 20 16.5 17.5 17 14.5C18 10.5 17.5 5.5 14.5 4.2C13.7 3.9 12.8 4 12 4Z"/>
        <path {...s} d="M12 8v4"/>
    ...
    gefaesse: (
      <>
        <path {...s} d="M2 11c1.5-4 3.5-4 5 0s3.5 4 5 0 3.5-4 5 0"/>
        <path {...s} d="M2 16c1.5-3 3.5-3 5 0s3.5 3 5 0 3.5-3 5 0"/>
      </>
    ),
    wirbelsaeule: (
      <>
        <rect {...s} x="7" y="2" width="10" height="4" rx="1.5"/>
        <rect {...s} x="7" y="10" width="10" height="4" rx="1.5"/>
        <rect {...s} x="7" y="18" width="10" height="4" rx="1.5"/>
        <line {...s} x1="12" y1="6" x2="12" y2="10"/>
        <line {...s} x1="12" y1="14" x2="12" y2="18"/>
      </>
    ),
    msk: (
      <>
        <path {...s} d="M6.5 6.5C6.5 4.8 8 3.5 9.5 4.5L14.5 9.5"/>
        <path {...s} d="M9.5 4.5C10.5 3 13 3 13.5 5"/>
        <path {...s} d="M17.5 17.5C17.5 19.2 16 20.5 14.5 19.5L9.5 14.5"/>
        <path {...s} d="M14.5 19.5C13.5 21 11 21 10.5 19"/>
    ...
    'hu-werte': (
      <>
        ...
        <line {...s} x1="12" y1="3" x2="12" y2="8.5"/>
        <line {...s} x1="12" y1="15.5" x2="12" y2="21"/>
        <line {...s} x1="3" y1="12" x2="8.5" y2="12"/>
        <line {...s} x1="15.5" y1="12" x2="21" y2="12"/>
      </>
    ),
  }
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" aria-hidden="true" style={{ flexShrink: 0 }}>
      {icons[id] ?? <circle cx="12" cy="12" r="5" fill="currentColor"/>}
    </svg>
  )
}
