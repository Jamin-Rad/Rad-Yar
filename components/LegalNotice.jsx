...
const COPY = {
  de: {
    ...
    analytics: 'Mit deiner Erlaubnis erfassen wir Seitenaufrufe, Nutzungsdauer und anonyme Weiterempfehlungsaktionen, um RadYar und Node-RADS zu verbessern. Ohne Erlaubnis bleibt diese Analyse ausgeschaltet.',
    necessary: 'Nur notwendige Funktionen', allow: 'Analyse erlauben',
  },
  en: {
    eyebrow: 'Welcome to RadYar', title: 'Important information before you start',
    ...
    analytics: 'With your permission, we record page views, usage time and anonymous sharing actions to improve RadYar and Node-RADS. This analysis stays off without permission.',
    necessary: 'Necessary functions only', allow: 'Allow analytics',
  },
  fa: {
    eyebrow: 'به رادیار خوش آمدید', title: 'نکات مهم پیش از شروع',
    ...
    analytics: 'با اجازه شما، بازدید صفحات، مدت استفاده و اشتراک‌گذاری‌های ناشناس برای بهبود رادیار و Node-RADS ثبت می‌شود. بدون اجازه این تحلیل غیرفعال می‌ماند.',
    necessary: 'فقط امکانات ضروری', allow: 'اجازه تحلیل',
  },
}
