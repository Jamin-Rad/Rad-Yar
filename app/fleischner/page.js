...
const COPY = {
  de: {
    ...
    primaryRec: 'Empfohlenes Vorgehen', context: 'Einordnung', report: 'Befund und Beurteilung', copy: 'Text kopieren', copied: 'Kopiert',
  ...
  en: {
    ...
    primaryRec: 'Recommended management', context: 'Interpretation', report: 'Findings and impression', copy: 'Copy text', copied: 'Copied',
