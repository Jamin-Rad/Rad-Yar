...
Nicht verwechseln mit den deutlich feineren und irregulären fine linear calcifications.`}</Lines></p></div></article>
    ...
    <article className={`${caseStyles.caseStudy} ${caseStyles.exampleCoarse}`}>
      ...
      <p className={caseStyles.caseDescription}><strong>Morphologie und Lage:</strong> Mehrere große, grobe und glatt begrenzte Verkalkungen in der rechten Brust – typisch benigne grobschollige Morphologie.</p>
