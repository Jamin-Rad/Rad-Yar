...
const MORPHOLOGY_IMAGES={
  round:{src:'/mamma/mammographie/verkalkungen/morphology/round.png',width:309,height:1024,alt:L('Runde, scharf begrenzte Verkalkungen mit Vergrößerung','Round, well-defined calcifications with magnified view','کلسیفیکاسیون‌های گرد و با حدود مشخص همراه با نمای بزرگ‌نمایی‌شده')},
  amorph:{src:'/mamma/mammographie/verkalkungen/morphology/amorphous.png',width:304,height:1024,alt:L('Amorphe, unscharf begrenzte Verkalkungen mit Vergrößerung','Amorphous, indistinct calcifications with magnified view','کلسیفیکاسیون‌های آمورف و نامشخص همراه با نمای بزرگ‌نمایی‌شده')},
  coarse:{src:'/mamma/mammographie/verkalkungen/morphology/coarse-heterogeneous.png',width:305,height:1024,alt:L('Grob heterogene Verkalkungen mit Vergrößerung','Coarse heterogeneous calcifications with magnified view','کلسیفیکاسیون‌های درشت ناهمگون همراه با نمای بزرگ‌نمایی‌شده')},
  pleomorphic:{src:'/mamma/mammographie/verkalkungen/morphology/fine-pleomorphic.png',width:304,height:1024,alt:L('Fein pleomorphe Verkalkungen mit Vergrößerung','Fine pleomorphic calcifications with magnified view','کلسیفیکاسیون‌های ظریف پلئومورفیک همراه با نمای بزرگ‌نمایی‌شده')},
  linear:{src:'/mamma/mammographie/verkalkungen/morphology/fine-linear-branching.png',width:307,height:1024,alt:L('Fein lineare und verzweigte Verkalkungen mit Vergrößerung','Fine linear and branching calcifications with magnified view','کلسیفیکاسیون‌های ظریف خطی و شاخه‌دار همراه با نمای بزرگ‌نمایی‌شده')},
}
...
function GermanContent(){return <>
  ...
  <Section {...GERMAN_SECTIONS[2]} title={GERMAN_SECTIONS[2].label.de}>
    ...
    <div className={`${styles.morphRail} ${caseStyles.morphologyScale}`}>
      <article className={caseStyles.morphBenign}><span>01</span><h3>Rund</h3><MorphologyImage type="round"/><p>Glatte, runde Verkalkungen. Diffuse oder bilaterale Verteilung spricht eher für einen benignen Befund.</p></article>
      <article className={caseStyles.morphBenign}><span>02</span><h3>Amorph</h3><MorphologyImage type="amorph"/><p>Sehr kleine, unscharf definierte Verkalkungen ohne klar erkennbare Form. Die Verteilung ist besonders wichtig.</p></article>
      <article className={caseStyles.morphIntermediate}><span>03</span><h3>Grob heterogen</h3><MorphologyImage type="coarse"/><p>Irreguläre Verkalkungen, größer als amorphe, aber weniger typisch als grobschollige benigne Verkalkungen.</p></article>
      <article className={caseStyles.morphIntermediate}><span>04</span><h3>Fein pleomorph</h3><MorphologyImage type="pleomorphic"/><p>Feine Verkalkungen unterschiedlicher Form und Größe. Die Pleomorphie ist ein relevantes Suspektkriterium.</p></article>
      <article className={caseStyles.morphSuspicious}><span>05</span><h3>Fein linear / verzweigt</h3><MorphologyImage type="linear"/><p>Sehr feine, irreguläre lineare oder verzweigte Verkalkungen mit der höchsten Suspektheit.</p></article>
    </div>
