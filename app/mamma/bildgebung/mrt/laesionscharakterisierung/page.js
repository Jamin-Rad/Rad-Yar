    ...
    <div className={base.layout}>
      ...
      <div className={base.main}>
        ...
        <Section id="mass" eyebrow="03 · Mass" title={tx(SECTIONS[2].label)}>
          ...
          <TeachingImage className="referenceMedia" src="/mamma/mrt/lesion-characterization/mass-internal-enhancement-reference.png" width={1226} height={1283} caption={{ de: 'Mass: internes Anreicherungsmuster – Referenzübersicht', en: 'Mass: Internal Enhancement – reference overview', fa: 'Mass: الگوی Enhancement داخلی – نمای مرجع' }} alt={{ de: 'Referenzübersicht der internen Mass-Anreicherung: homogen, heterogen, randständig und dunkle interne Septierungen', en: 'Reference overview of internal mass enhancement: homogeneous, heterogeneous, rim enhancement and dark internal septations', fa: 'نمای مرجع الگوهای Enhancement داخلی Mass: Homogeneous، Heterogeneous، Rim Enhancement و Dark Internal Septations' }} />
