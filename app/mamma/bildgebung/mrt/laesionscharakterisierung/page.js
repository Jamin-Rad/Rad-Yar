    ...
    <div className={base.layout}>
      ...
      <div className={base.main}>
        ...
        <Section id="mass" eyebrow="02 · Mass" title={tx(SECTIONS[1].label)}>
          ...
          <ReportExample label={{ de: 'So klingt ein klarer Befund', en: 'A clear report sounds like this', fa: 'نمونه گزارش واضح' }} text={{ de: 'Rechts bei 10 Uhr zeigt sich eine 13 × 10 × 9 mm große, irregulär geformte Mass mit spikuliertem Rand und heterogenem internem Enhancement.', en: 'At 10 o’clock in the right breast, there is a 13 × 10 × 9 mm irregular mass with a spiculated margin and heterogeneous internal enhancement.', fa: 'در ساعت ۱۰ پستان راست، Mass نامنظم به ابعاد ۱۳ × ۱۰ × ۹ میلی‌متر با حاشیه اسپیکوله و Enhancement داخلی ناهمگن دیده می‌شود.' }} checklist={[{ de: 'Seite · Uhrzeit · Abstand zur Mamille', en: 'Side · clock position · distance from nipple', fa: 'سمت · موقعیت ساعت · فاصله از نوک پستان' }, { de: 'Größe in drei Ebenen', en: 'Size in three dimensions', fa: 'اندازه در سه بعد' }, { de: 'Form · Rand · internes Enhancement', en: 'Shape · margin · internal enhancement', fa: 'Shape · Margin · Enhancement داخلی' }, { de: 'T2 · DWI/ADC · Kinetik · Vorvergleich', en: 'T2 · DWI/ADC · kinetics · comparison', fa: 'T2 · DWI/ADC · کینتیک · مقایسه قبلی' }]} />
        </Section>
