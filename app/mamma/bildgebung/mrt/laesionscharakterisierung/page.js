    ...
    <div className={base.layout}>
      ...
      <div className={base.main}>
        <Section id="start" eyebrow={tx({ de: '01 · Focus, Mass oder NME?', en: '01 · Focus, mass or NME?', fa: '۰۱ · Focus، Mass یا NME؟' })} title={tx(SECTIONS[0].label)}>
          ...
          <figure className={styles.overviewMedia}><a href="/mamma/mrt/laesionscharakterisierung-overview.png" target="_blank" rel="noreferrer" aria-label={tx(COPY.zoom)}><Image src="/mamma/mrt/laesionscharakterisierung-overview.png" alt={tx(COPY.figureCaption)} width={1536} height={1024} sizes="(max-width: 900px) calc(100vw - 40px), 900px" priority /></a><figcaption><strong>{tx(COPY.figureCaption)}</strong><span>{tx(COPY.zoom)}</span></figcaption></figure>
