...
export const MASS_ENHANCEMENT = [
  ...
  { term: L('Randständige Anreicherung', 'Rim Enhancement', 'Enhancement حاشیه‌ای'), text: L('Das Kontrastmittel reichert sich vorwiegend am Rand der Läsion an.', 'Contrast enhancement is predominantly located at the lesion rim.', 'Enhancement عمدتاً در حاشیه ضایعه دیده می‌شود.'), sub: L('Dieses Muster ist häufig suspekt, besonders bei invasiven Karzinomen.', 'This pattern is often suspicious, particularly in invasive carcinomas.', 'این الگو اغلب مشکوک است، به‌ویژه در کارسینوم‌های مهاجم.') },
  { term: L('Dunkle interne Septierungen', 'Dark Internal Septations', 'سپتاهای داخلی تیره'), text: L('Innerhalb einer anreichernden Mass zeigen sich dunkle Septen ohne Kontrastmittelanreicherung.', 'Dark non-enhancing septa are seen within an enhancing mass.', 'درون یک Mass دارای Enhancement، سپتاهای تیره و بدون Enhancement دیده می‌شوند.'), sub: L('Bei ansonsten benigner Morphologie ist dies ein klassischer Hinweis auf ein Fibroadenom.', 'With otherwise benign morphology, this is a classic clue to fibroadenoma.', 'در صورت وجود مورفولوژی خوش‌خیم، این یافته کلاسیک به نفع فیبروآدنوم است.') },
]
