...
const CONTENT = {
  ...
  "fa": {
    ...
    "extra": {
      ...
      "items": [
        {
          "title": "بیماری یونگلینگ (Morbus Jüngling)",
          "text": "استئیت کیستیک متعدد با استئولیزهای تونل‌مانند در فالانژهای دست و پا."
        },
        {
          "title": "سارکوئیدوز قلبی",
          "text": "معمولاً با MRI قلب و Late Gadolinium تقویت پس از تزریق تشخیص داده می‌شود؛ خطر آریتمی افزایش می‌یابد."
        },
        {
