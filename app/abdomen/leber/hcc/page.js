...
const CONTENT = {
  ...
  fa: {
    ...
    heroCards: [
      { value: 'APHE', label: 'تقویت شریانی بیش از پارانشیم', text: 'الگوی غیرحلقوی' },
    ...
    basics: {
      ...
      items: [
        ...
        { title: 'بیولوژی تومور', text: 'با ددیفرانسیاسیون، خون‌رسانی شریانی افزایش و خون‌رسانی پورت کاهش می‌یابد و APHE و سپس واش‌اوت ایجاد می‌شود.' },
        { title: 'اهمیت بالینی', text: 'تعداد، اندازه، تهاجم عروقی، گسترش خارج کبدی و عملکرد کبد مرحله و درمان را تعیین می‌کنند.' },
      ],
      key: 'الگوی تقویت پس از تزریق تیپیک فقط همراه با زمینه بالینی پرخطر مناسب ارزش تشخیصی قابل اعتماد دارد.',
    },
    ct: {
      title: 'تشخیص با CT دینامیک', lead: 'تصویربرداری چندفازی با زمان‌بندی صحیح ضروری است. HCC ممکن است بدون کنتراست نامشخص باشد و با تقویت پس از تزریق نسبی دیده شود.',
      ...
      rows: [
        ...
        ['شریانی دیررس', 'افزایش سیگنال شریانی غیرحلقوی (APHE) نسبت به کبد', 'ویژگی اصلی'],
        ['پورتال/تأخیری', 'واش‌اوت غیرمحیطی', 'هیپودنسیته نسبی فزاینده'],
        ['تأخیری', 'کپسول دارای تقویت پس از تزریق یا نمای کپسول ممکن است', 'ویژگی اضافی بدخیمی'],
      ],
      highlightTitle: "واش‌اوت یک یافته نسبی است", highlightText: "واش‌اوت الزاماً به معنی خروج مطلق کنتراست نیست؛ ضایعه نسبت به کبدی که بیشتر تقویت پس از تزریق می‌یابد، تیره‌تر می‌شود.",
      key: 'افزایش سیگنال شریانی غیرحلقوی (APHE) همراه واش‌اوت غیرمحیطی الگوی دینامیک کلاسیک HCC در بیمار پرخطر است.',
    },
    mri: {
      ...
      rows: [
        ...
        ['دینامیک', 'افزایش سیگنال شریانی غیرحلقوی (APHE)، واش‌اوت، کپسول دارای تقویت پس از تزریق', 'ویژگی‌های اصلی LI-RADS'],
      ...
      cards: [
        ...
        { title: 'تومور داخل ورید', text: 'بافت نرم با تقویت پس از تزریق مشابه تومور درون ورید به نفع تهاجم ماکروواسکولار است و مرحله و درمان را تغییر می‌دهد.' },
      ],
      cave: 'تقویت شریانی بیش از پارانشیم به‌تنهایی HCC را اثبات نمی‌کند. FNH، آدنوم، شانت آرتریوپورتال و متاستازهای هیپرواسکولار می‌توانند مشابه باشند.',
      key: 'APHE، واش‌اوت، نمای کپسول، رشد و تومور داخل ورید باید سیستماتیک گزارش شوند.',
    },
    infiltrative: {
      ...
      rows: [
        ['مورفولوژی', 'رشد نفوذی با حدود نامشخص به‌جای توده منفرد و مشخص'],
        ['تقویت پس از تزریق', 'ناهمگن؛ APHE یا واش‌اوت کلاسیک ممکن است فقط به‌صورت کانونی دیده شود یا وجود نداشته باشد'],
        ['یافته‌های همراه', 'ندول‌های ماهواره‌ای، تهاجم عروقی و ترومبوس توموری پورت شایع هستند'],
        ['افتراق', 'فیبروز همگرا، اختلال پرفیوژن، متاستاز منتشر یا التهاب'],
      ],
      cave: 'نبود واش‌اوت کلاسیک HCC انفیلتراتیو را رد نمی‌کند. عروق، DWI، تصاویر قبلی و زمینه خطر باید دقیق بررسی شوند.',
      key: "رشد نفوذی، ندول‌های ماهواره‌ای و تهاجم عروقی سرنخ‌های اصلی HCC انفیلتراتیو تهاجمی هستند.",
    },
    cases: {
      ...
      items: [
        { title: 'HCC در CT چندفازی', tags: ['CT', 'APHE', 'wash-out', 'کپسول'], text: 'مرد ۶۰ ساله با سیروز و HCC سگمان ۵: تقویت شریانی قوی، واش‌اوت پورتال و نمای کپسول.', credit: 'Michael P. Hartung · Radiopaedia rID-197181', url: 'https://radiopaedia.org/cases/hepatocellular-carcinoma-multiphase-exam' },
        { title: 'HCC انفیلتراتیو با ضایعات ماهواره‌ای', tags: ['CT', 'انفیلتراتیو', 'ماهواره‌ای'], text: "مرد ۸۰ ساله با سابقه الکل: کنگلومرای نفوذی بزرگ، ضایعات شریانی متعدد و واش‌اوت هتروژن.", credit: 'Michael P. Hartung · Radiopaedia rID-61803', url: 'https://radiopaedia.org/cases/infiltrative-hepatocellular-carcinoma-hcc' },
      ],
    },
    takehome: {
      title: 'نکات کلیدی', lead: 'مهم‌ترین نکات برای گزارش و آزمون.',
      items: [
        { title: 'ابتدا زمینه', text: 'تشخیص تصویربرداری HCC و LI-RADS فقط در گروه پرخطر مناسب استفاده شود.' },
        { title: 'الگوی کلاسیک', text: 'افزایش سیگنال شریانی غیرحلقوی (APHE) همراه واش‌اوت غیرمحیطی و اغلب نمای کپسول.' },
