...
const CONTENT = {
  ...
  "fa": {
    ...
    "sono": {
      ...
      "key": "یک همانژیوم کوچک، با حدود کاملاً مشخص و اکوژن، در زمینه‌ی کبد طبیعی و با مورفولوژی تیپیک، اغلب نیازی به بررسی تکمیلی با CT یا MRI ندارد."
    },
    "ct": {
      "title": "تشخیص در CT",
      "lead": "همانژیوم تیپیک در CT دینامیک، تقویت پس از تزریق ندولار محیطی و ناپیوسته با پرشدگی آهسته از محیط به مرکز نشان می‌دهد.",
      "tableHeaders": [
        "فاز",
        "یافته"
      ],
      "tableRows": [
        [
          "بدون کنتراست",
          "ضایعه هیپودنس با حاشیه شارپ و واضح"
        ],
        [
          "شریانی زودرس",
          "تقویت پس از تزریق ندولار محیطی و ناپیوسته"
        ],
        [
          "پورتال",
          "پرشدگی مرکزگرا از حاشیه به مرکز"
        ],
        [
          "تأخیری",
          "به‌تدریج هموژن، گاهی با تقویت پس از تزریق پایدار و واضح"
        ]
      ],
      "irisTitle": "پدیده پدیده دیافراگم عنبیه",
      "irisText": "پدیده پدیده دیافراگم عنبیه: جذب ماده حاجب از محیط به سمت مرکز پیش می‌رود؛ شبیه دیافراگم عنبیه که از بیرون به داخل بسته می‌شود.",
      "irisImageAlt": "پدیده دیافراگم عنبیه در همانژیوم کبدی طی چهار فاز CT",
      "cave": "تقویت پس از تزریق ندولار محیطی را نباید با تقویت حلقوی بدخیم اشتباه گرفت: همانژیوم آهسته از محیط به مرکز پر می‌شود."
    },
    "mri": {
      "title": "تشخیص در MRI",
      "lead": "MRI زمانی بسیار کمک‌کننده است که سونوگرافی یا CT قطعی نباشد. نکته کلیدی، T2 بسیار روشن و تقویت پس از تزریق دینامیک مرکزگرا است.",
      "tableHeaders": [
        "سکانس",
        "یافته تیپیک",
        ""
      ...
      "tableRows": [
        [
          "T1 بدون تزریق",
          "کم‌سیگنال تا هم‌سیگنال نسبت به کبد",
          ""
        ],
        [
          "T2",
          "سیگنال بسیار روشن؛ علامت لامپ روشن (Light-bulb sign)",
          "گاهی حتی روشن‌تر از صفرا"
        ],
        [
          "DWI",
          "پرسیگنال در b-value بالا",
          "همراه با ADC تفسیر شود"
        ],
        [
          "ADC",
          "ADC بالا",
          "به نفع اثر عبور سیگنال T2 (shine-through) و علیه محدودیت واقعی انتشار"
        ],
        [
          "T1 پس از تزریق، فاز شریانی",
          "تقویت پس از تزریق ندولار و لکه‌ای محیطی",
          "شروع از حاشیه"
        ],
        [
          "T1 پس از تزریق، فاز پورتال/تأخیری",
          "پرشدگی مرکزگرا با تقویت پس از تزریق پایدار",
          "الگوی کلاسیک همانژیوم"
        ]
      ],
      "lightBulbTitle": "علامت لامپ روشن",
      "lightBulbText": "همانژیوم تیپیک در T2 بسیار پرسیگنال است. همانژیوم‌های کوچک اغلب هموژن هستند، ولی ضایعات بزرگ‌تر می‌توانند به علت فیبروز، کلسیفیکاسیون یا ترومبوز ناهمگون باشند.",
      "dwiTitle": "تفسیر درست DWI",
      "dwiText": "همانژیوم ممکن است در مقادیر بالای b پرسیگنال دیده شود. تفسیر DWI بدون ADC کامل نیست: اگر DWI روشن باشد اما ADC کاهش متناظر نداشته باشد، یافته ناشی از اثر عبور سیگنال T2 (shine-through) است و محدودیت واقعی انتشار محسوب نمی‌شود.",
      "imageAlt": "نمودار آموزشی علامت لامپ روشن و اثر عبور سیگنال T2 در همانژیوم کبدی",
      "lightBulbKey": "علامت لامپ روشن (Light-bulb sign): سیگنال بسیار روشن در T2 برای همانژیوم تیپیک است.",
      "dwiKey": "سیگنال روشن در DWI بدون کاهش متناظر ADC، به معنای اثر عبور سیگنال T2 (shine-through) است و محدودیت واقعی انتشار محسوب نمی‌شود."
    },
    "atypical": {
      ...
      "tableRows": [
        [
          "T2",
          "به‌شدت پرسیگنال، علامت لامپ روشن",
          "ناهمگون پرسیگنال، اغلب کمتر درخشان"
        ],
        [
          "DWI/ADC",
          "پرسیگنال در b-value بالا، ADC بالا",
          "پرسیگنال محیطی، کاهش خفیف ADC ممکن است"
        ],
        [
          "T1 C+",
          "ندولار محیطی + مرکزگرا",
          "اغلب تقویت همگن و قوی در فاز شریانی"
        ]
      ],
      "key": "همانژیوم آتیپیک می‌تواند متاستاز را تقلید کند. پیگیری، تقویت پس از تزریق مرکزگرا، ADC و مقایسه با تصاویر قبلی کمک‌کننده هستند."
    },
    "takehome": {
      "title": "Take home message",
      ...
      "items": [
        {
          "title": "الگوی کلاسیک",
          "text": "تقویت پس از تزریق ندولار محیطی + پرشدگی مرکزگرا = تیپیک برای همانژیوم."
        },
        {
        ...
        },
        {
          ...
          "text": "سیگنال روشن در DWI بدون کاهش متناظر ADC، به معنای اثر عبور سیگنال T2 (shine-through) است و محدودیت واقعی انتشار محسوب نمی‌شود."
        },
        {
          "title": "ضایعه آتیپیک",
          "text": "اگر تقویت پس از تزریق کلاسیک وجود ندارد، متاستاز و سایر ضایعات کبدی باید دقیق افتراق داده شوند."
        }
      ]
    }
  }
  ...
  fa: {
    ...
    cases: [
      ...
      },
      {
        ...
        meta: 'خانم ۳۵ ساله با ضایعه اتفاقی در سگمان V؛ سری T1 C+ پورتال‌ونوس پرشدگی تدریجی پیشرونده و مرکزگرا را نشان می‌دهد.',
        credit: 'Case courtesy of Bahman Rasuli, Radiopaedia.org, rID-209408, CC BY-NC-SA 3.0',
        url: 'https://radiopaedia.org/cases/209408/play',
      },
    ],
