...
const CONTENT = {
  de: {
    ...
    sections: [
      ...
      { id: 'ct', label: 'CT-Diagnostik', icon: '02' },
      { id: 'cdd', label: 'CDD-Klassifikation', icon: '03' },
      { id: 'komplikationen', label: 'Komplikationen', icon: '04' },
      { id: 'befundung', label: 'Befundung', icon: '05' },
      { id: 'faelle', label: 'Fallbeispiele', icon: '06' },
      { id: 'takehome', label: 'Take home', icon: '07' },
    ],
    heroCards: [
  ...
  en: {
    ...
    sections: [
      { id: 'grundlagen', label: 'Basics', icon: '01' },
      { id: 'ct', label: 'CT diagnosis', icon: '02' },
      { id: 'cdd', label: 'CDD classification', icon: '03' },
      { id: 'komplikationen', label: 'Complications', icon: '04' },
      { id: 'befundung', label: 'Reporting', icon: '05' },
      { id: 'faelle', label: 'Cases', icon: '06' },
      { id: 'takehome', label: 'Take home', icon: '07' },
    ],
    heroCards: [
