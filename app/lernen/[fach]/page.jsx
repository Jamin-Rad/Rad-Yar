...
function MskChapterIcon({ id, className }) {
  ...
  const icons = {
    ...
    'msk-knie': <><path d="M9 7c5 6 9 12 13 18 2 3 6 4 9 2l2-1"/><path d="M13 5c4 7 8 13 12 18"/><path d="M31 28c3 3 7 6 13 9M28 32c4 4 8 7 13 11"/><path d="M29 28c-3 0-6 2-7 5M24 24c3-2 7-2 10 0"/><ellipse cx="20" cy="29" rx="3" ry="4" transform="rotate(-35 20 29)"/></>,
