...
CONTENT.fa = {
  ...
  csp: {
    ...
    rows: [
      ...
      ['سیگنال/دانسیته', 'در CT و تمام سکانس‌های MRI مشابه CSF', 'بدون جزء جامد یا تقویت پس از تزریق'],
  ...
  differential: {
    ...
    report: [
      ...
      { title: '۲. توصیف', text: 'اندازه، سیگنال مشابه CSF، دیواره صاف و نبود تقویت پس از تزریق را ذکر کنید.' },
  ...
  fa: {
    ...
    hydro: {
      ...
      danger: [
        ...
        { title: 'فوریت', text: "هیدروسفالی انسدادی حاد یک اورژانس جراحی مغز و اعصاب است." },
      ],
