...
const COPY = {
  ...
  fa: {
    ...
    stats: [['I-III', 'درجه‌بندی MRI از کشیدگی تا پارگی کامل'], ['ACL', 'شایع‌ترین آسیب رباطی زانو'], ['PLC', "علامت آرکوات (Arcuate sign) به عنوان هشدار مهم"]],
    toc: 'محتوا',
    nav: [['grading', 'درجه‌بندی MRI'], ['lateral', 'لترال / PLC'], ['medial', 'مدیال / MCL'], ['acl', 'ACL'], ['pcl', 'PCL'], ['cases', 'کیس‌ها'], ['takehome', 'نکات کلیدی']],
    sections: {},
    figures: {},
  },
}
...
COPY.fa.sections = {
  ...
  lateral: {
    ...
    note: "نکته حفظی: شکستگی Segond در تیبیا به نفع پارگی ACL است؛ علامت آرکوات (Arcuate sign) در فیبولا به نفع ناپایداری خلفی-لترال است.",
  },
  medial: {
  ...
  takehome: {
    ...
    items: [
      ...
      ['02', 'لترال یعنی PLC را هم ببین', "در کمپلکس لترال، LCL، تاندون بایسپس فموریس، پوپلیتئوس و کمپلکس آرکوات را با هم ارزیابی کن. علامت آرکوات (Arcuate sign) در سر فیبولا هشدار ناپایداری خلفی-لترال است."],
...
COPY.fa.figures = {
  lateral: [
    ...
    ['/knieligamente/arcuate-sign.png', "علامت آرکوات (Arcuate sign): کندگی سر فیبولا به نفع آسیب PLC."],
  ],
  medial: [
